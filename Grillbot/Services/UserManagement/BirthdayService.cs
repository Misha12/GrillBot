...
namespace Grillbot.Services.UserManagement
{
    public class BirthdayService : IDisposable
    {
        ...
        {
            var dbUser = UsersRepository.GetOrCreateUser(guild.Id, user.Id, false, true, false, false, false);
        ...
        {
            var dbUser = UsersRepository.GetUser(guild.Id, user.Id, false, true, false, false, false);
