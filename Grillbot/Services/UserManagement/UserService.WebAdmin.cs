    ...
    public partial class UserService
    {
        ...
        public bool AuthenticateWebAccess(SocketGuild guild, SocketGuildUser user, string password, out long userID)
        {
            ...
            lock (locker)
            {
                ...
                var userEntity = repository.GetUser(guild.Id, user.Id, false, false, false, false, false, false);
        ...
        public string AddUserToWebAdmin(SocketGuild guild, SocketGuildUser user, string password = null)
        {
            ...
            lock (locker)
            {
                ...
                var userEntity = repository.GetOrCreateUser(guild.Id, user.Id, false, false, false, false, false, false);
