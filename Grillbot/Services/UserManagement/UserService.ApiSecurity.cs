...
namespace Grillbot.Services.UserManagement
{
    public partial class UserService
    {
        public string GenerateApiToken(SocketGuild guild, SocketUser user)
        {
            ...
            var dbUser = repository.GetOrCreateUser(guild.Id, user.Id, false, false, false, false, false, false);
        ...
        public void ReleaseApiToken(SocketGuild guild, SocketUser user)
        {
            ...
            var dbUser = repository.GetUser(guild.Id, user.Id, false, false, false, false, false, false);
