...
namespace Grillbot.Migrations
{
    ...
    [Migration("20200808194855_NewUnverify")]
    partial class NewUnverify
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Grillbot.Database.Entity.Users.Unverify", b =>
                {
                    b.Property<long>("UserID")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Grillbot.Database.Entity.Users.Unverify", b =>
                {
                    b.HasOne("Grillbot.Database.Entity.Users.DiscordUser", "User")
                        .WithOne("Unverify")
                        .HasForeignKey("Grillbot.Database.Entity.Users.Unverify", "UserID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
