using Grillbot.Services.Math.Functions;
    ...
    public class ExpressionParser
    {
        ...
        public ExpressionParser(string data)
        {
            ...
            try
            {
                ...
                if (string.IsNullOrEmpty(expressionData) || string.Equals("nan", expressionData, StringComparison.InvariantCultureIgnoreCase)) return;
